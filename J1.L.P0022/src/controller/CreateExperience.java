 ...
 * @author namdng09
 */
public class CreateExperience extends Form {
    ...
    public STATUS_PROGRAM setup() {
        ...
        Candidate candidate = view.inputCandidate("---------- Input Experience ----------", 0);
        Experience experience = view.intputExperience(candidate);
        
        try {
            manager.insert(experience);
        } catch (Exception e) {
